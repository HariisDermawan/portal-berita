...
function Hiburan() {
  ...
  useEffect(() => {
    ...
    if (savedComments) {
      ...
      const sampleComments = [
        {
          id: 1,
          name: 'Budi Santoso',
          content: 'Festival musiknya keren banget! Sayang ga bisa nonton langsung.',
          ...
          replies: [
            {
              id: 101,
              name: 'Admin',
              content: 'Tahun depan bisa datang!',
        ...
        },
        {
          id: 2,
          name: 'Siti Rahayu',
          content: 'Film Indonesia makin berkualitas. Bangga jadi sineas Indonesia! 🎬',
        ...
        },
        {
          id: 3,
          name: 'Andi Wijaya',
          content: 'Konser kemarin meriah banget! Sound systemnya mantap!',
      ...
      localStorage.setItem('hiburanComments', JSON.stringify(sampleComments))
    }
  ...
  useEffect(() => {
    if (comments.length > 0) {
      localStorage.setItem('hiburanComments', JSON.stringify(comments))
    }
  }, [comments])
  ...
  const hiburanNews = [
    {
      ...
      title: 'Festival Musik Internasional 2026 Dipadati Ribuan Penonton',
      description: 'Artis dari berbagai negara tampil memukau dalam festival musik terbesar tahun ini. Lebih dari 50.000 penonton hadir meramaikan acara.',
      date: '10 Mei 2026',
      category: 'Musik',
      views: '45.2K',
      author: 'Music Editor'
    },
    {
      ...
      title: 'Film Indonesia Berhasil Menembus Box Office Asia',
      description: 'Industri perfilman Indonesia semakin mendapat perhatian dunia internasional. Film terbaru berhasil meraih 2 juta penonton.',
      date: '9 Mei 2026',
      category: 'Film',
      views: '32.8K',
      author: 'Movie Critic'
    },
    {
      ...
      title: 'Konser Band Legendaris Berlangsung Meriah di Jakarta',
      description: 'Puluhan ribu penggemar memadati stadion untuk menyaksikan konser spektakuler band legendaris Indonesia.',
      date: '8 Mei 2026',
      category: 'Konser',
      views: '28.5K',
      author: 'Concert Reviewer'
    },
    {
      id: 4,
      image: 'https://images.unsplash.com/photo-1521334884684-d80222895322?q=80&w=1200',
      title: 'Fashion Show Modern Tampilkan Tren Terbaru Tahun 2026',
      description: 'Desainer ternama memperkenalkan konsep fashion futuristik dan elegan yang diprediksi menjadi tren tahun ini.',
      date: '7 Mei 2026',
      category: 'Fashion',
      views: '23.7K',
    ...
    },
    {
      ...
      title: 'Creator Content Indonesia Mendunia Lewat Platform Digital',
      description: 'Konten kreator lokal berhasil meraih jutaan penonton dari berbagai negara berkat konten berkualitas.',
      date: '6 Mei 2026',
      category: 'Creator',
      views: '38.9K',
    ...
    },
    {
      ...
      title: 'Drama Series Terbaru Jadi Trending di Asia Tenggara',
      description: 'Serial terbaru sukses menarik perhatian penonton dengan alur cerita unik dan akting memukau.',
      date: '5 Mei 2026',
      category: 'Series',
      views: '29.4K',
      author: 'TV Critic'
    },
    {
      ...
      title: 'Album Baru Penyanyi Populer Dirilis, Langsung Trending',
      description: 'Album terbaru langsung menduduki puncak tangga lagu di berbagai platform streaming musik.',
      date: '4 Mei 2026',
      category: 'Musik',
      views: '52.1K',
    ...
    },
    {
      ...
      title: 'Ajang Penghargaan Musik Bergengsi Digelar Malam Ini',
      description: 'Para musisi tanah air berkumpul dalam ajang penghargaan musik terbesar tahun ini.',
      date: '3 Mei 2026',
      category: 'Musik',
      views: '41.3K',
      author: 'Award Show Reporter'
    },
    {
      id: 9,
      image: 'https://images.unsplash.com/photo-1533105079780-92b9be482077?q=80&w=1200',
      title: 'Kolaborasi Artis Indonesia-Korea Jadi Sorotan',
      description: 'Kolaborasi lintas negara ini berhasil menciptakan lagu yang viral di berbagai platform.',
      date: '2 Mei 2026',
      category: 'Musik',
      views: '67.8K',
      author: 'Music Collaborator'
    }
  ]

  const trendingHiburan = [
    {
      image: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?q=80&w=400',
      title: 'Festival Musik Paling Dinanti Tahun Ini Sukses Digelar',
      category: 'Musik',
      views: '85.2K'
    },
    {
      image: 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?q=80&w=400',
      title: 'Film Indonesia Sabet Penghargaan Internasional',
      category: 'Film',
      views: '62.7K'
    },
    {
      image: 'https://images.unsplash.com/photo-1516280440614-37939bbacd81?q=80&w=400',
      title: 'Konser Band Legendaris Sold Out dalam Hitungan Menit',
      category: 'Konser',
      views: '54.3K'
    }
  ]

  const popularHiburan = [
    '10 Konser Paling Spektakuler di Indonesia 2026',
    'Rekomendasi Film Indonesia Terbaru yang Wajib Ditonton',
    'Tren Fashion 2026 yang Akan Menginspirasi Anda',
    'Creator Content Indonesia dengan Penonton Terbanyak',
    'Drama Korea Terpopuler Versi Penonton Indonesia'
  ]

  const categories = [
    { name: 'Semua', icon: FaTheaterMasks, count: 9 },
    { name: 'Musik', icon: FaMusic, count: 3 },
    { name: 'Film', icon: FaFilm, count: 1 },
    { name: 'Konser', icon: FaMicrophoneAlt, count: 1 },
    { name: 'Fashion', icon: FaTshirt, count: 1 },
    { name: 'Creator', icon: FaVideo, count: 1 },
    { name: 'Series', icon: FaStar, count: 1 }
  ]
  ...
  const filteredNews = selectedCategory === 'semua'
    ? hiburanNews
    : hiburanNews.filter(news => news.category.toLowerCase() === selectedCategory.toLowerCase())
    ...
    >
      ...
      >
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mt-2 sm:mt-3 md:mt-4">
          Berita <span className="text-red-500">Hiburan</span>
        </h1>

        <p className="text-gray-500 text-sm sm:text-base md:text-lg mt-3 sm:mt-4 md:mt-5 max-w-3xl leading-relaxed">
          Ikuti kabar terbaru dunia hiburan mulai dari musik, film, konser,
            ...
            <div className="flex items-center gap-3 sm:gap-4 mt-4 sm:mt-5 md:mt-6">
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-sm sm:text-base">
                  {filteredNews[0]?.author || 'Entertainment Admin'}
                </h4>
              ...
              <div className="bg-gradient-to-r from-gray-800 to-gray-900 px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <h3 className="text-white font-bold text-base sm:text-lg">
                    Diskusi Hiburan ({comments.length})
                  </h3>
                </div>
                <button
                ...
                <div className="p-4 sm:p-6">
                  <div className="mb-6 sm:mb-8">
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea
                        placeholder={replyTo ? `Membalas ${replyTo.name}...` : "Tulis komentar Anda tentang hiburan..."}
                        value={newComment}
        ...
        >
          ...
          >
            ...
            <div className="space-y-4 sm:space-y-5">
              {trendingHiburan.map((item, index) => (
                <motion.div
                  key={index}
          ...
          >
            <div className="text-center mb-3 sm:mb-4">
              ...
              <p className="text-[10px] sm:text-xs text-gray-500 mt-1">Dapatkan update hiburan terbaru</p>
            </div>
          ...
          <motion.div
            ...
            variants={itemVariants}
          >
            <h3 className="font-bold text-lg sm:text-xl mb-2">Entertainment Newsletter</h3>
            <p className="text-white/80 text-xs sm:text-sm mb-3 sm:mb-4">
              Dapatkan berita hiburan terbaru langsung ke email Anda
            </p>
            <input
              type="email"
